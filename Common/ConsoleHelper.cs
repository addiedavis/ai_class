...
namespace Common
{
    public static class ConsoleHelper
    {
                                                                           ...
                                                                           )
        {
            ...
            var matrix = new CrossValConfusionMatrix();
            foreach (var c in metricsInMultipleFolds)
            {
                matrix.AddConfusionMatrix(c.ConfusionMatrix);
            }
            ...
            Console.WriteLine(matrix.GetPrettyConfusionMatrix());
            Console.WriteLine($"*************************************************************************************************************");
        }
